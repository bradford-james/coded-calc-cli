...
module.exports = class CLI {
  ...
  run() {
    if (this.err != '') this.showError(err);
    this.getDisplay();
    ...
    readline.question("Enter command: ", async receivedInput => {
      switch (receivedInput) {
        ...
        default:
          await this.calculator.handleInput(receivedInput);
          break;
      }
      this.run();
    });
  ...
  showHelp() {
    ...
    console.log('-------------------------  ||  -------------------------------');
    console.log('|                       |  ||  |                             |');
    console.log('|       -BUTTONS-       |  ||  |         -KEY CODES-         |');
    console.log('|                       |  ||  |                             |');
    console.log('-------------------------  ||  -------------------------------');
    console.log('|   AC/C    | +/- |  +  |  ||  | ALL_CLR/CLR   | SIGN  | ADD |');
    console.log('-------------------------  ||  -------------------------------');
    console.log('|  1  |  2  |  3  |  -  |  ||  | ONE   | TWO   | THREE | SUB |');
    console.log('-------------------------  ||  -------------------------------');
    console.log('|  4  |  5  |  6  |  /  |  ||  | FOUR  | FIVE  | SIX   | MUL |');
    console.log('-------------------------  ||  -------------------------------');
    console.log('|  7  |  8  |  9  |  x  |  ||  | SEVEN | EIGHT | NINE  | DIV |');
    console.log('-------------------------  ||  -------------------------------');
    console.log('|     0     |  .  |  =  |  ||  | ZERO          | DEC   | EQ  |');
    console.log('-------------------------  ||  -------------------------------');
    console.log('\n');
